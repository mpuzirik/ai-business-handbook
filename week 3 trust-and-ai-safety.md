...
Under the GDPR, personal data includes information that can identify a person. The GDPR also requires organisations to use only the data that is necessary for a specific purpose.

For a small marketing agency, this means that confidential client information, personal data and sensitive project information should not automatically be entered into an external AI tool. The company should first check the AI provider’s terms, data-processing conditions and internal rules.
...
Human oversight is an important principle in the EU AI Act. People using AI should be able to understand and monitor the system and take action when necessary.

For a marketing agency, a practical rule is:

AI can suggest → a human checks → the human decides.

For example, AI can create a first version of an advertisement or client email. A human employee should check the information, tone, accuracy and potential risks before it is sent to a client or published.
...
Transparency is also becoming an important part of the EU AI Act. From 2 August 2026, certain transparency obligations apply to AI providers and deployers, including rules related to interactions with AI and AI-generated content.

For a marketing agency, employees should therefore follow company rules about AI use and, where relevant, be transparent about AI-generated or AI-assisted content.
...
3. Do not put confidential client information into external AI tools without checking whether this is allowed and how the data is handled.
4. Keep human approval for important client communication, published content and business decisions.
...
Team checked: the sources, important claims, practical recommendations and safety boundaries.
